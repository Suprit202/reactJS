...
export function ControlledDemo1() {
  ...
  function GridView() {
    setView(<DataGrid1 caption='User details mention here' fields={['First Name','Last Name','age','Standard']} data={[{firstName:'David', lastName:'Brick', age:'23', std:'9th'}, {firstName:'Reno', lastName:'Leaf', age:'25', std:'10th'}]}></DataGrid1>);
  }

  function CardView() {
    setView(<DataCard caption='User details mention here' fields={['First Name','Last Name','age','Standard']} data={[{firstName:'David', lastName:'Brick', age:'23', std:'9th'}, {firstName:'Reno', lastName:'Leaf', age:'25', std:'10th'}]}></DataCard>)
  }
